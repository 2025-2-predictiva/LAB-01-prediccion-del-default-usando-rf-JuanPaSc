...
print("Columnas ID eliminadas correctamente")
# - Elimine los registros con informacion no disponible.
...
print("Registros con información no disponible eliminados correctamente")

# - Para la columna EDUCATION, valores > 4 indican niveles superiores
#   de educación, agrupe estos valores en la categoría "others".
train_data["EDUCATION"] = train_data["EDUCATION"].apply(lambda x: 4 if x > 4 else x)
test_data["EDUCATION"] = test_data["EDUCATION"].apply(lambda x: 4 if x > 4 else x)
print("Valores de EDUCATION agrupados correctamente")
...
print("Datasets divididos en variables explicativas y objetivo")
...
def make_grid_search(pipeline, X_train, y_train):
    ...
    model = GridSearchCV(
        pipeline, param_grid, cv=10, scoring="balanced_accuracy", n_jobs=-1, verbose=1
    )
...
print("Grid search realizado correctamente")
